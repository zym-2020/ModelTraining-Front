...
export default {
  ...
  setup() {
    ...
    if (eId == "1-1" || eId == "1-2") {
      ...
      readyWord =
        "<h2>形式：文本、流程图</h2><h2>建议内容:</h2><ul><li>研究对象</li><li>地点</li><li>时间</li><li>人物</li><li>方法</li></ul>";
    } else if (eId == "2-1") {
      readyWord =
        "<h2>建议格式:OpenGMS standard</h2>\
      ...
      readyWord =
        "<h2>建议内容:</h2><ul><li>名称</li><li>描述</li><li>位置</li><li>格式</li><li>版本</li><li>单位</li><li>生产时间</li><li>更新时间</li><li>小数位</li>\
